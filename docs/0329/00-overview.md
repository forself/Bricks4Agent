...
| [02-broker-core.md](02-broker-core.html) | Broker Core 核心邏輯 | `packages/csharp/broker-core/` | 26+ 領域模型、18+ 服務、16 步 PEP 流程、PolicyEngine |

### 基礎設施

| 文件 | 模組 | 路徑 | 說明 |
|---|---|---|---|
| [03-api-database-security.md](03-api-database-security.html) | API / 資料庫 / 安全 | `packages/csharp/api,database,security/` | 帳戶鎖定、MFA、稽核日誌、速率限制、BaseOrm (多資料庫)、BaseCache |
| [04-cache-subsystem.md](04-cache-subsystem.html) | 快取子系統 | `packages/csharp/cache-*/` | TCP 二進位協定、30+ OpCode、叢集堆疊（選主/複製/快照） |

### 執行層

| 文件 | 模組 | 路徑 | 說明 |
|---|---|---|---|
| [05-workers-and-execution.md](05-workers-and-execution.html) | Workers / SDK / Function Pool | `packages/csharp/workers,worker-sdk,function-pool/` | 3 Workers（LINE/File/Browser）、TCP Worker SDK、三層調度策略 |

### 支援模組

| 文件 | 模組 | 路徑 | 說明 |
|---|---|---|---|
| [06-logging-reporting-utils.md](06-logging-reporting-utils.html) | 日誌 / 報表 / 工具類別 | `packages/csharp/logging,reporting,utils/` | BaseLogger (5 輸出目標)、ClosedXML Excel 報表、DateTimeHelper/PaginationHelper |
...
| 文件 | 模組 | 路徑 | 說明 |
|---|---|---|---|
| [08-tools-templates-projects.md](08-tools-templates-projects.html) | 工具 / 範本 / 專案 | `tools/`, `templates/`, `projects/` | DefinitionTemplate 系統、Agent v2.0 多模型、品質驗證腳本套件 |
| [09-frontend-and-ui.md](09-frontend-and-ui.html) | 前端與 UI | `packages/javascript/browser/` | 70+ UI 元件、DynamicPageRenderer、TriggerEngine、管理介面 |
