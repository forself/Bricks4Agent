...
```jsonc
{
  ...
  "category": "form",                          // common|form|input|layout|sections|social|editor|data|viz|utils|analytics
...
| 用途 | 路徑 |
|---|---|
| 設計系統(設計說明) | [ui_components/DESIGN-SYSTEM.md](packages/javascript/browser/ui_components/DESIGN-SYSTEM.html) |
| 主題/客製(使用說明) | [ui_components/THEME-USAGE.md](packages/javascript/browser/ui_components/THEME-USAGE.html) |
