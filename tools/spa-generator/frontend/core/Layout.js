            ...
            <aside class="layout-sidebar" data-collapsed="false">
                <div class="sidebar-header">
                    <div class="sidebar-logo">
                        ...
                        <span class="logo-text">SPA Generator</span>
                    </div>
                ...
                <nav class="sidebar-nav">
                    ...
                    <a href="#/project" class="nav-item" data-path="/project">
                        <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/>
                        </svg>
                        <span class="nav-text">建立專案</span>
                    </a>
                    <a href="#/page" class="nav-item" data-path="/page">
                        <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                            <polyline points="14 2 14 8 20 8"/>
                        </svg>
                        <span class="nav-text">生成頁面</span>
                    </a>
                    <a href="#/api" class="nav-item" data-path="/api">
                        ...
                        <span class="nav-text">生成 API</span>
                    </a>
                    <a href="#/feature" class="nav-item" data-path="/feature">
                        <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polygon points="12 2 2 7 12 12 22 7 12 2"/>
                            <polyline points="2 17 12 22 22 17"/>
                            <polyline points="2 12 12 17 22 12"/>
                        </svg>
                        <span class="nav-text">完整功能</span>
                    </a>
                    ...
                    <!-- 社群瀏覽 -->
                    <div class="nav-group-label"><span class="nav-text">社群瀏覽</span></div>
                    ...
                    <!-- 員警社群 -->
                    <div class="nav-group-label"><span class="nav-text">員警社群</span></div>
