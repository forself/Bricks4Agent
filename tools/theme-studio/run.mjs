...
async function run() {
    ...
    try {
        ...
        addResult(results, 'gallery 精確覆蓋 catalog 116', checks.gallery.total === 116 && checks.gallery.rendered + checks.gallery.skipped + checks.gallery.failed === 116 && checks.gallery.zone === 'gallery', JSON.stringify(checks.gallery));
