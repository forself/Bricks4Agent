...
public class AdaptiveSizingTests
{
    ...
    {
        var sized = AutoTraderSizingService.ApplyAdaptiveSizing(
    ...
    public void NormalizeKelly_MaxFraction_ReturnsOne()
    {
        ...
        AutoTraderSizingService.NormalizeKellyToFactor(0.25m).Should().Be(1m);
    }
    ...
    public void NormalizeKelly_HalfMax_ReturnsHalf()
    {
        ...
        AutoTraderSizingService.NormalizeKellyToFactor(0.125m).Should().Be(0.5m);
    }
    ...
    public void NormalizeKelly_Zero_ReturnsZero()
    {
        ...
        AutoTraderSizingService.NormalizeKellyToFactor(0m).Should().Be(0m);
    }
    ...
    public void NormalizeKelly_AboveMax_ClampsToOne()
    {
        ...
        AutoTraderSizingService.NormalizeKellyToFactor(0.5m).Should().Be(1m);
    }

    [Fact]
    public void NormalizeKelly_Negative_ClampsToZero()
    {
        AutoTraderSizingService.NormalizeKellyToFactor(-0.1m).Should().Be(0m);
    }
}
