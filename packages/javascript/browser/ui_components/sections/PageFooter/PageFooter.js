...
export class PageFooter {
    ...
    _injectStyles() {
        if (document.getElementById('pagefooter-component-styles')) return;
        const s = document.createElement('style');
        s.id = 'pagefooter-component-styles';
        s.textContent = `
            .cl-pagefooter { padding: 24px; border-top: 1px solid var(--cl-border); display: flex; flex-direction: column; gap: 10px; }
            .cl-pagefooter-links { display: flex; gap: 16px; flex-wrap: wrap; }
        `;
