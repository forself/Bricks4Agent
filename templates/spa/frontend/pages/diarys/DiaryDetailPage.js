/**
 * DiaryDetail - DiaryDetail 頁面
 *
 * @module DiaryDetailPage
 */

import { BasePage } from '../../core/BasePage.js';

export class DiaryDetailPage extends BasePage {
    async onInit() {
        this._data = {
            item: null,
            loading: true,
    ...
    async _loadItem() {
        ...
        try {
            ...
            // TODO: 替換為實際 API 呼叫
            // const item = await this.api.get(`/diarys/${id}`);
            ...
            console.error('[DiaryDetailPage] 載入失敗:', error);
    ...
    template() {
            ...
            return `
                <div class="diary-detail-page">
                    <div class="error-state">
                        <h2>找不到資料</h2>
                        <a href="#/diarys/diary-detail" class="btn">返回列表</a>
                    </div>
                </div>
            `;
        }
        ...
        return `
            <div class="diary-detail-page">
                <div class="page-back">
                    <a href="#/diarys/diary-detail" class="back-link">
    ...
    onEdit() {
        this.navigate(`/diarys/diary-detail/${this.params.id}/edit`);
    }
    ...
    async onDelete() {
        ...
        try {
            // await this.api.delete(`/diarys/${this.params.id}`);
            this.showMessage('已刪除', 'success');
            this.navigate('/diarys/diary-detail');
        } catch (error) {
