...
export class CheckoutPage extends BasePage {
    ...
    async _loadData() {
        try {
            ...
            // TODO: 替換為實際 API 呼叫
            // const items = await this.api.get('/checkout');
            ...
            console.error('[CheckoutPage] 載入資料失敗:', error);
        ...
        return `
            <div class="checkout-page">
                <header class="page-header">
                    <h1>Checkout</h1>
                    <p class="page-subtitle">Checkout 頁面</p>
                </header>
    ...
    onEdit(event, target) {
        ...
        this.navigate(`/checkout/${id}/edit`);
    }
    ...
    async onDelete(event, target) {
        ...
        try {
            // await this.api.delete(`/checkout/${id}`);
