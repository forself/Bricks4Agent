...
export class ProfilePage extends BasePage {
    ...
    async _loadData() {
        try {
            ...
            // TODO: 替換為實際 API 呼叫
            // const items = await this.api.get('/profile');
            ...
            console.error('[ProfilePage] 載入資料失敗:', error);
        ...
        return `
            <div class="profile-page">
                <header class="page-header">
                    <h1>Profile</h1>
                    <p class="page-subtitle">Profile 頁面</p>
                </header>
    ...
    async onDelete(event, target) {
        ...
        try {
            // await this.api.delete(`/profile/${id}`);
