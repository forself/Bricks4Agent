...
export class ProductListPage extends BasePage {
    ...
    async _loadData() {
        try {
            ...
            // TODO: 替換為實際 API 呼叫
            // const items = await this.api.get('/products');
            ...
            console.error('[ProductListPage] 載入資料失敗:', error);
        ...
        return `
            <div class="product-list-page">
                <header class="page-header">
                    <h1>ProductList</h1>
                    <p class="page-subtitle">ProductList 頁面</p>
                </header>
    ...
    onEdit(event, target) {
        ...
        this.navigate(`/products/product-list/${id}/edit`);
    }
