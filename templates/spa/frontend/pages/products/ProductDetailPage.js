/**
 * ProductDetail - ProductDetail 頁面
 *
...
export class ProductDetailPage extends BasePage {
    ...
    async _loadItem() {
        ...
        try {
            ...
            // TODO: 替換為實際 API 呼叫
            // const item = await this.api.get(`/products/${id}`);
            ...
            console.error('[ProductDetailPage] 載入失敗:', error);
    ...
    template() {
            ...
            return `
                <div class="product-detail-page">
                    <div class="error-state">
                        <h2>找不到資料</h2>
                        <a href="#/products/product-detail" class="btn">返回列表</a>
                    </div>
                </div>
            `;
        }
        ...
        return `
            <div class="product-detail-page">
                <div class="page-back">
                    <a href="#/products/product-detail" class="back-link">
    ...
    onEdit() {
        this.navigate(`/products/product-detail/${this.params.id}/edit`);
    }
    ...
    async onDelete() {
        ...
        try {
            // await this.api.delete(`/products/${this.params.id}`);
            this.showMessage('已刪除', 'success');
            this.navigate('/products/product-detail');
        } catch (error) {
