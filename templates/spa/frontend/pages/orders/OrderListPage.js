/**
 * OrderList - OrderList 頁面
 *
 * @module OrderListPage
 */
...
export class OrderListPage extends BasePage {
    ...
    async _loadData() {
        try {
            ...
            // TODO: 替換為實際 API 呼叫
            // const items = await this.api.get('/orders');
            ...
            console.error('[OrderListPage] 載入資料失敗:', error);
        ...
        return `
            <div class="order-list-page">
                <header class="page-header">
                    <h1>OrderList</h1>
                    <p class="page-subtitle">OrderList 頁面</p>
                </header>
    ...
    onEdit(event, target) {
        ...
        this.navigate(`/orders/order-list/${id}/edit`);
    }
