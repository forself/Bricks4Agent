/**
 * AdminOrder - AdminOrder 頁面
 *
 * @module AdminOrderPage
 */
...
export class AdminOrderPage extends BasePage {
    ...
    async _loadData() {
        try {
            ...
            console.error('[AdminOrderPage] 載入資料失敗:', error);
        ...
        return `
            <div class="admin-order-page">
                <header class="page-header">
                    <h1>AdminOrder</h1>
                    <p class="page-subtitle">AdminOrder 頁面</p>
                </header>
    ...
    onEdit(event, target) {
        ...
        this.navigate(`/admin/admin-order/${id}/edit`);
    }
