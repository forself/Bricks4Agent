/**
 * AdminCategory - AdminCategory 頁面
 *
 * @module AdminCategoryPage
 */

import { BasePage } from '../../core/BasePage.js';

export class AdminCategoryPage extends BasePage {
    async onInit() {
        this._data = {
            items: [],
            loading: true,
    ...
    async _loadData() {
        try {
            ...
            // TODO: 替換為實際 API 呼叫
            // const items = await this.api.get('/admin');
            ...
            console.error('[AdminCategoryPage] 載入資料失敗:', error);
        ...
        return `
            <div class="admin-category-page">
                <header class="page-header">
                    <h1>AdminCategory</h1>
                    <p class="page-subtitle">AdminCategory 頁面</p>
                </header>
    ...
    onEdit(event, target) {
        ...
        this.navigate(`/admin/admin-category/${id}/edit`);
    }
