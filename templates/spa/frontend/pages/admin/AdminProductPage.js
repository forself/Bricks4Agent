/**
 * AdminProduct - AdminProduct 頁面
 *
 * @module AdminProductPage
 */
...
export class AdminProductPage extends BasePage {
    ...
    async _loadData() {
        try {
            ...
            console.error('[AdminProductPage] 載入資料失敗:', error);
        ...
        return `
            <div class="admin-product-page">
                <header class="page-header">
                    <h1>AdminProduct</h1>
                    <p class="page-subtitle">AdminProduct 頁面</p>
                </header>
    ...
    onEdit(event, target) {
        ...
        this.navigate(`/admin/admin-product/${id}/edit`);
    }
