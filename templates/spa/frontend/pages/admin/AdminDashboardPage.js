/**
 * AdminDashboard - AdminDashboard 頁面
 *
...
export class AdminDashboardPage extends BasePage {
    ...
    async _loadData() {
        try {
            ...
            console.error('[AdminDashboardPage] 載入資料失敗:', error);
        ...
        return `
            <div class="admin-dashboard-page">
                <header class="page-header">
                    ...
                    <p class="page-subtitle">AdminDashboard 頁面</p>
                </header>
    ...
    onEdit(event, target) {
        ...
        this.navigate(`/admin/admin-dashboard/${id}/edit`);
    }
