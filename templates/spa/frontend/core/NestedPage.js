...
import { canvasIconMarkup } from '../components/CanvasIcon.js';
...
export class NestedPage extends BasePage {
    ...
    _getIcon(name) {
        const icons = {
            list: canvasIconMarkup('list', 16),
            plus: canvasIconMarkup('plus', 16),
            edit: canvasIconMarkup('edit', 16),
            user: canvasIconMarkup('user', 16),
            settings: canvasIconMarkup('settings', 16),
        };
        return icons[name] || '';
    }
